...
function getVerseNumber(signallist)
    ...
    while i <= table.getn(workinglist) do
        ...
        if i == 0 then
            table.insert(outputlist, Verbindungssteuerzeichenzeichen[str(signallist[sB_StropheVerbindung])][0])
        elseif i == 1 then
            table.insert(outputlist, Verbindungssteuerzeichenzeichen[str(signallist[sB_StropheVerbindung])][1])
        end
        i = i + 1
    end
    --Liste in String zurückwandlen
